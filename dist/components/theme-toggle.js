export const DarkModeToggle = () => {
    // Define the HTML structure for the toggle
    const html = `
  ...
  `;
    ...
    const initializeToggle = () => {
        ...
        // Set up event listener after DOM is loaded
    ...
    initializeToggle();
    // Return HTML for manual insertion if needed
    return html;
};
// At the bottom of theme-toggle.ts
DarkModeToggle();
