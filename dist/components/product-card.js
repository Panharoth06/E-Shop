...
class ProductListPage {
    ...
    productListCard(product) {
        ...
        const quickViewBtn = this.createElement("button", {
            className: "px-4 py-2 border border-gray-300 text-green-400 text-sm font-medium rounded-full hover:bg-gray-50 transition-colors",
            textContent: "Quick View",
            onclick: (e) => {
                e.preventDefault();
                e.stopPropagation();
...
export function createProductGridCard(product) {
