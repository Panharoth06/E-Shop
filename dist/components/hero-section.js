class HeroSection {
    constructor(containerId) {
        ...
        this.data = {
            ...
            description: "Shop the latest trends with unbeatable prices and lightning-fast delivery. Your satisfaction is our priority.",
            primaryButton: {
                text: "Shop Now",
    ...
    createButton(text, isPrimary = true, onClick) {
    ...
    createFeaturesList() {
        ...
        this.data.features.forEach((feature, index) => {
            ...
            const checkIcon = this.createElement("div", "w-5 h-5 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0");
            checkIcon.innerHTML = `
    ...
    createStatsSection() {
        ...
        this.data.stats.forEach((stat, index) => {
            ...
            const statNumber = this.createElement("div", "text-3xl rounded-md font-bold gradient-bg bg-clip-text text-white", stat.number);
    ...
    createHeroContent() {
        const heroSection = this.createElement("section", `
    ...
    `
        ...
        const shape1 = this.createElement("div", `
...
`
            .trim()
            .replace(/\s+/g, " "));
        const shape2 = this.createElement("div", `
...
`
    ...
    `
        ...
        // Scroll indicator
        const scrollIndicator = this.createElement("div", `
